...
IMX_DEVICE_PATH := device/trucrux/imx8m/trux_imx8mp_q01
else
...
define build_imx_uboot
	...
	cp $(UBOOT_OUT)/arch/arm/dts/imx8mp-trux-8MDVP.dtb $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/.; \
	cp $(UBOOT_OUT)/arch/arm/dts/imx8mp-trux-8MDVP-legacy.dtb $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/.; \
