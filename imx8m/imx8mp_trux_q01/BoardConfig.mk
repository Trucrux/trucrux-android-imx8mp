...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/imx8mp_trux_q01/dtbo-imx8mp-trux-8MDVP.img

ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
    TARGET_BOARD_DTS_CONFIG := \
	 imx8mp-trux-8MDVP:imx8mp-trux-8MDVP.dtb \
	 imx8mp-trux-8MDVP-legacy:imx8mp-trux-8MDVP-legacy.dtb \
	 imx8mp-trux-8MDVP-hdmi:imx8mp-trux-8MDVP-hdmi.dtb \
	 imx8mp-trux-8MDVP-legacy-hdmi:imx8mp-trux-8MDVP-legacy-hdmi.dtb \
	 imx8mp-trux-8MDVP-m7:imx8mp-trux-8MDVP-m7.dtb \
	 imx8mp-trux-8MDVP-legacy-m7:imx8mp-trux-8MDVP-legacy-m7.dtb
