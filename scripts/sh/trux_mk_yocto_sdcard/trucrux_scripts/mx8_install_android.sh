...
if [[ "$img" == *"imx8mp-trux-8MDVP-legacy-hdmi"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M-PLUS HDMI on 8MDVP 1.x)")
	elif [[ "$img" == *"imx8mp-trux-8MDVP-legacy-m7"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M-PLUS M7 LVDS on 8MDVP 1.x)")
	elif [[ "$img" == *"imx8mp-trux-8MDVP-legacy"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M-PLUS LVDS on 8MDVP 1.x)")
	elif [[ "$img" == *"imx8mp-trux-8MDVP-hdmi"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M-PLUS HDMI on 8MDVP 2.x)")
	elif [[ "$img" == *"imx8mp-trux-8MDVP-m7"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M-PLUS M7 LVDS on 8MDVP 2.x)")
	elif [[ "$img" == *"imx8mp-trux-8MDVP"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M-PLUS LVDS on 8MDVP 2.x)")
		...
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 1.x WIFI+LVDS+HDMI)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-legacy-wifi-lvds"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 1.x WIFI+LVDS)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-legacy-wifi-hdmi"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 1.x WIFI+HDMI)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-legacy-wifi-lvds-dp"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 1.x WIFI+LVDS+DP)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-legacy-wifi-dp"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 1.x WIFI+DP)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-wifi-lvds-hdmi"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 2.x WIFI+LVDS+HDMI)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-wifi-lvds"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 2.x WIFI+LVDS)")
	elif [[ "$img" == *"imx8mq-trux-8MDVP-wifi-hdmi"* ]]; then
		img_list+=("$img (Trucurx TRUX-MX8M on 8MDVP 2.x WIFI+HDMI)")
	else
		img_list+=($img)
	fi
done
...
if [[ "${soc_name}" = *"imx8mp"* ]]; then
	...
	bootloader_file="u-boot-imx8mp-trux-q01.imx"
fi
