...
if [[ "${soc_name}" = *"imx8mm"* ]]; then
	imagesdir="out/target/product/trux_imx8mm_q01"
elif [[ "${soc_name}" = *"imx8mp"* ]]; then
	imagesdir="out/target/product/trux_imx8mp_q01"
	sdshared=false
elif [[ "${soc_name}" = *"imx8mq"* ]]; then
	imagesdir="out/target/product/trux_imx8mq_q01"
	sdshared=true
fi
